...
class Config
{
    ...
    * @example ['post_data'=>'PQRST::function']
    */
    public $post=[];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'PQRST::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','PQRST::function',10,2]
    * @example ['body_class',['PQRST','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','PQRST\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['example','PQRST\ExampleController::example_shortcode']
    ];
    /**
    * Dashboard
    ...
    */
    public $plugin_menu=[
        [
            "path"      => ["page"],
            "name"      => "Lista de Roles",
            "function"  => __NAMESPACE__."\RolesController::index",
